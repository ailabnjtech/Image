...
class vgg():
    ...
    def classname(self, prepath="./flower_photos/"):
    ...
    def generate_data(self, prepath="flower_photos/"):
        classes = os.listdir(prepath)  # 类别序号和名称
...
data = "datas/train_data.npy"
label = "label/labels.npy"
mode_path = "flower_photos/flowers_5classes.h5"
vgg16 = vgg((224, 224, 3), 5, data, label, mode_path)  # vgg16.generate_data()
